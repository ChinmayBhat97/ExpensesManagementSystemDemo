...
{
    public partial class ExpensesManagementSystem_UpdatedUIContext : DbContext
    {
        public ExpensesManagementSystem_UpdatedUIContext()
        {
        }

        public ExpensesManagementSystem_UpdatedUIContext(DbContextOptions<ExpensesManagementSystem_UpdatedUIContext> options)
            : base(options)
        {
        }
